        ...
        <div>
                        ...
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <div className='cart_quantity_container'>
                                    ...
                                    {/* Task 4: Contador dinámico del carrito */}
            ...
            {!showCart ? (
                <div className="product-grid">
                    {/* Task 1: Mapeo de categorías y plantas */}
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h2 className="category-title" style={{ textAlign: 'center', color: '#4CAF50', margin: '30px 0' }}>
                                {category.category}
                            </h2>
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        {/* Task 4: Botón controlado por estado */}
                                        <button
